...
export const DistributorFlowResolver = ({distributors, onDistributorSelect, distributorId}: DistributorFlowResolverProps) => {
    ...
    <Box>
      {
        distributors.length === 0 ? (
          ...
          <Box>
            <InputLabel id="SelectDistributor">Choose a distributor to which your plant will be assigned</InputLabel>
            <Controller
              control={control}
              name="distributorId"
