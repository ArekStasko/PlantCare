...
const getHumidityMeasurementTime = (data: HumidityMeasurement[]): string[] => data.map(c => {
...
const getHumidityMeasurementValues = (data: HumidityMeasurement[]): number[] => data.map(c => c.humidity)
