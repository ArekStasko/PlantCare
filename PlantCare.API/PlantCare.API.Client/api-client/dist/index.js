...
var Client = /*#__PURE__*/ function() {
   ...
   */ key: "waterSupply",
        ...
        },
        {
            /**
   * @return OK
   */ key: "removeWaterSupply",
            value: function removeWaterSupply(id, plantId, cancelToken) {
                var _this = this;
                var url_ = this.baseUrl + "/api/distributor/{id}/{plantId}/water-supply";
                if (id === void 0 || id === null) throw new globalThis.Error("The parameter 'id' must be defined.");
                url_ = url_.replace("{id}", encodeURIComponent("" + id));
                ...
                return this.instance.request(options_).catch(function(_error) {
                    ...
                    return _this.processRemoveWaterSupply(_response);
                });
            }
        },
        {
            key: "processRemoveWaterSupply",
            value: function processRemoveWaterSupply(response) {
                var status = response.status;
                var _headers = {};
                if (response.headers && _type_of(response.headers) === "object") {
                    for(var k in response.headers){
   ...
   */ key: "waterSupplyStatus",
            value: function waterSupplyStatus(id, cancelToken) {
                var _this = this;
                var url_ = this.baseUrl + "/api/distributor/{id}/water-supply/status";
                if (id === void 0 || id === null) throw new globalThis.Error("The parameter 'id' must be defined.");
                url_ = url_.replace("{id}", encodeURIComponent("" + id));
                url_ = url_.replace(/[?&]$/, "");
                var options_ = {
